...
const DeviceSupplierPage = () => {
  ...
  const columns: ProColumns<Supplier>[] = [
    ...
    { title: '品牌', dataIndex: 'brand', width: 160, sorter: true },
    {
      title: '联系方式',
  ...
  return (
    <PageContainer title="供应商">
      ...
      <ModalForm<SupplierFormValues>
        ...
        onFinish={async (values) => {
          const payload: SupplierPayload = {
            ...
            contact_info: values.contact_info?.trim() || undefined,
      ...
      >
        <ProFormText name="name" label="供应商名称" rules={[{ required: true, message: '请输入供应商名称' }]} />
